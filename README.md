...
Validated on 2026-09-18: frontend tests (2 per console), deployment configuration tests (11), production build, browser login-page rendering, real Supabase Workspace/Auth/Storage, and the authenticated Docker execution/report chain. Model generation is explicitly mock. Real-provider validation remains pending.
...
An open quality-engineering workbench with Web/API automation and portable Markdown/source AI capabilities. Full repository-wide enterprise analyzers, internal Wiki/EC connectors, complex knowledge retrieval, Data Pool, K8s and message-broker infrastructure remain out of scope. See each service's README for execution and security boundaries.
